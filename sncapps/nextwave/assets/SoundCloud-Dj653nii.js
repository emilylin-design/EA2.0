import { fe as T, ff as N, fg as x, f1 as A } from "./WidgetRenderer-C4Xp1hhZ.js";
function q(l, s) {
    ...
    if (typeof n != "string" && !Array.isArray(n)) {
      for (const i in n)
        if (i !== "default" && !(i in l)) {
          ...
          d && Object.defineProperty(l, i, d.get ? d : {
            enumerable: !0,
            get: () => n[i]
          });
        }
...
function U() {
  if (g) return f;
  g = 1;
  var l = Object.create, s = Object.defineProperty, p = Object.getOwnPropertyDescriptor, n = Object.getOwnPropertyNames, i = Object.getPrototypeOf, d = Object.prototype.hasOwnProperty, v = (t, e, r) => e in t ? s(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, O = (t, e) => {
    for (var r in e)
  ...
  var m = S(x), P = /* @__PURE__ */ T(), w = /* @__PURE__ */ N();
...
var b = /* @__PURE__ */ U();
const V = /* @__PURE__ */ A(b), F = /* @__PURE__ */ q({
  __proto__: null,
  default: V
}, [b]);
export {
...
//# sourceMappingURL=SoundCloud-Dj653nii.js.map
