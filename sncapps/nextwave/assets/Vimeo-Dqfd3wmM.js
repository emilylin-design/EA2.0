import { fe as L, ff as S, fg as k, f1 as R } from "./WidgetRenderer-C4Xp1hhZ.js";
function T(p, a) {
  for (var u = 0; u < a.length; u++) {
    ...
    if (typeof n != "string" && !Array.isArray(n)) {
      for (const l in n)
        if (l !== "default" && !(l in p)) {
          const h = Object.getOwnPropertyDescriptor(n, l);
          h && Object.defineProperty(p, l, h.get ? h : {
            enumerable: !0,
            get: () => n[l]
          });
        }
...
function q() {
  if (g) return d;
  g = 1;
  var p = Object.create, a = Object.defineProperty, u = Object.getOwnPropertyDescriptor, n = Object.getOwnPropertyNames, l = Object.getPrototypeOf, h = Object.prototype.hasOwnProperty, v = (t, e, r) => e in t ? a(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, O = (t, e) => {
    for (var r in e)
      a(t, r, { get: e[r], enumerable: !0 });
  }, f = (t, e, r, y) => {
    if (e && typeof e == "object" || typeof e == "function")
      for (let i of n(e))
        !h.call(t, i) && i !== r && a(t, i, { get: () => e[i], enumerable: !(y = u(e, i)) || y.enumerable });
    return t;
  }, D = (t, e, r) => (r = t != null ? p(l(t)) : {}, f(
    ...
    t
  )), V = (t) => f(a({}, "__esModule", { value: !0 }), t), s = (t, e, r) => (v(t, typeof e != "symbol" ? e + "" : e, r), r), m = {};
  O(m, {
    default: () => c
  }), d = V(m);
  var _ = D(k), P = /* @__PURE__ */ L(), w = /* @__PURE__ */ S();
  const M = "https://player.vimeo.com/api/player.js", j = "Vimeo", E = (t) => t.replace("/manage/videos", "");
  class c extends _.Component {
    ...
    load(e) {
      this.duration = null, (0, P.getSDK)(M, j).then((r) => {
        if (!this.container)
          return;
        const { playerOptions: y, title: i } = this.props.config;
  ...
  return s(c, "displayName", "Vimeo"), s(c, "canPlay", w.canPlay.vimeo), s(c, "forceLoad", !0), d;
}
var b = /* @__PURE__ */ q();
const x = /* @__PURE__ */ R(b), N = /* @__PURE__ */ T({
  __proto__: null,
  default: x
}, [b]);
export {
...
//# sourceMappingURL=Vimeo-Dqfd3wmM.js.map
